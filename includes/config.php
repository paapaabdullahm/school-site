	...
	*/
	...
	switch ( $host ) 
	{
		case 'fijai-shs': {
			...
			$config['slogan'] 						= "young souls";
			$config['motto'] 							= "ad astra per aspera";
			$config['country'] 						= "ghana";
			$config['zip_code'] 					= "( +233 )";
			$config['sch_status'] 				= "Reopened"; // Vacated
			$config['sch_status_date'] 		= "as @ May 5 2014";
			$config['sch_name_short'] 		= 'fijai-shs';
			$config['sch_name_long'] 			= "fijai senior high school";
			$config['color'] 							= "#965292"; 
			$config['sch_mobile'] 				= "050 . 679 . 7760";
			$config['twitter'] 						= "https://twitter.com/fijai-shs";
			$config['google'] 						= "https://www.google.com/+fijai-shs";
			$config['facebook'] 					= "https://www.facebook.com/fijai-shs";
			$config['youtube'] 						= "https://www.youtube.com/fijai-shs";
		} break;
