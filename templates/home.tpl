	...
	<div id='content' class='Forground'>
		<div id='right-segement'> 
			...
			<div class="vertical-menu">
				...
				<div class="label next-divider">{$assoc_plural} <!--i class="fa fa-graduation-cap"></i--></div>
				</a>
		...
		<div id='recent-additions' class=''>
			<div class='header'><h3 class=''>Recent Additions Noteworthy</h3><a href='#'><i class='list icon'></i>Show All</a></div>
				...
				src="{$recent_additions_source}" frameborder="0" scrolling="no"
	  ...
	  <div class="content">
		<div class="container"> 
		  ...
		  <div class="ui form segment" ng-controller="RegisterController"> 
			...
			<div class="ui inverted dimmer" ng-class="{literal}{true: 'active', false: 'disabled'}{/literal}[loading]">
