...
*/		
#content {
  min-height:1274px; height:1274px;
...
*/
#left-floated-bottom-grid { background: rgb(238,246,252); float: left; /*border-radius:0px;*/}
...
#secondary-content {
  ...
  .left-floated-column {
    ...
    .left-floated-column P.title {
      width: 155px;
      display: inline-block;
      padding: 0.4em 0 0em 0; margin: 0em 0.5em;
...
#recent-additions {
  ...
  text-align: left;
  height: 96px;
  border-bottom: 1px solid rgb(78,110,241);
  /*width: 550px;*/
